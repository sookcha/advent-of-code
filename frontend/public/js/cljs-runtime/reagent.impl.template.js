...
var G__52239 = o;
goog.object.set(G__52239,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__52432__delegate = function (args){
...
while (G__52433__i < G__52433__a.length) {G__52433__a[G__52433__i] = arguments[G__52433__i + 0]; ++G__52433__i;}
  args = new cljs.core.IndexedSeq(G__52433__a,0,null);
} 
return G__52432__delegate.call(this,args);};
G__52432.cljs$lang$maxFixedArity = 0;
G__52432.cljs$lang$applyTo = (function (arglist__52434){
var args = cljs.core.seq(arglist__52434);
return G__52432__delegate(args);
});
...
var G__52244 = o;
goog.object.set(G__52244,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52435__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52435 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52436__i = 0, G__52436__a = new Array(arguments.length -  0);
while (G__52436__i < G__52436__a.length) {G__52436__a[G__52436__i] = arguments[G__52436__i + 0]; ++G__52436__i;}
  args = new cljs.core.IndexedSeq(G__52436__a,0,null);
} 
return G__52435__delegate.call(this,args);};
G__52435.cljs$lang$maxFixedArity = 0;
G__52435.cljs$lang$applyTo = (function (arglist__52437){
var args = cljs.core.seq(arglist__52437);
return G__52435__delegate(args);
});
...
var G__52247 = props;
var G__52247__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52247,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52247);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52247__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52251 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52251,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52251;
}
})(),id_class);
...
var G__52266 = (cljs.core.count(argv) - first_child);
switch (G__52266) {
case (0):
...
var vec__52313 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52313,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52313,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52313,(2),null);
...
var temp__5757__auto___52439 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52439 == null)){
} else {
var key_52440 = temp__5757__auto___52439;
(jsprops.key = key_52440);
}
...
var temp__5757__auto___52441 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52441 == null)){
} else {
var key_52442 = temp__5757__auto___52441;
(jsprops.key = key_52442);
}
...
var temp__5757__auto___52443 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___52443 == null)){
} else {
var key_52444 = temp__5757__auto___52443;
(jsprops.key = key_52444);
}
...
var temp__5757__auto___52445 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52445 == null)){
} else {
var key_52446 = temp__5757__auto___52445;
(jsprops.key = key_52446);
}
...
var temp__5757__auto___52447 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52447 == null)){
} else {
var key_52448 = temp__5757__auto___52447;
(jsprops.key = key_52448);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52422_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52422_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52423 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52423,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52423,(1),null);
...
break;
default:
var G__52450 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52451 = compiler;
v = G__52450;
compiler = G__52451;
continue;
...
var G__52427 = tag;
var G__52427__$1 = (((G__52427 instanceof cljs.core.Keyword))?G__52427.fqn:null);
switch (G__52427__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52429 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52429 = (function (opts,id,fn_to_element,parse_fn,meta52430){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template52429.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52431,meta52430__$1){
var self__ = this;
var _52431__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52429(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52430__$1));
}));

(reagent.impl.template.t_reagent$impl$template52429.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52431){
var self__ = this;
var _52431__$1 = this;
return self__.meta52430;
}));

(reagent.impl.template.t_reagent$impl$template52429.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52429.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52429.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52429.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52429.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52429.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52430","meta52430",-967024600,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52429.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52429.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52429");

(reagent.impl.template.t_reagent$impl$template52429.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template52429");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52429.
 */
reagent.impl.template.__GT_t_reagent$impl$template52429 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52429(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52430){
return (new reagent.impl.template.t_reagent$impl$template52429(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52430));
});

}

return (new reagent.impl.template.t_reagent$impl$template52429(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
