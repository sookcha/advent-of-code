...
var i_46627 = (self__.level + (1));
while(true){
if((i_46627 <= (new_level + (1)))){
(update[i_46627] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_46629 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46629[i]));
} else {
x__$2.forward.push((((i < links_46629.length))?(links_46629[i]):null));
}

if((i < links_46629.length)){
(links_46629[i] = x__$2);
} else {
links_46629.push(x__$2);
}
...
var i_46631 = (0);
while(true){
if((i_46631 <= self__.level)){
var links_46632 = (update[i_46631]).forward;
if((x__$1 === (((i_46631 < links_46632.length))?(links_46632[i_46631]):null))){
(links_46632[i_46631] = (x__$1.forward[i_46631]));

var G__46633 = (i_46631 + (1));
i_46631 = G__46633;
continue;
} else {
var G__46634 = (i_46631 + (1));
i_46631 = G__46634;
continue;
}
} else {
...
var G__46636 = nx;
var G__46637 = (level__$1 - (1));
x = G__46636;
level__$1 = G__46637;
continue;
} else {
var G__46638 = x;
var G__46639 = (level__$1 - (1));
x = G__46638;
level__$1 = G__46639;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46641 = nx;
var G__46642 = (level__$1 - (1));
x = G__46641;
level__$1 = G__46642;
continue;
} else {
var G__46643 = x;
var G__46644 = (level__$1 - (1));
x = G__46643;
level__$1 = G__46644;
continue;
}
