...
var len__4818__auto___42895 = arguments.length;
var i__4819__auto___42896 = (0);
while(true){
if((i__4819__auto___42896 < len__4818__auto___42895)){
args__4824__auto__.push((arguments[i__4819__auto___42896]));

var G__42897 = (i__4819__auto___42896 + (1));
i__4819__auto___42896 = G__42897;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42799){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42800,G__42801,seq42799__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42849_SHARP_){
return (!((cljs.core.meta(p1__42849_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42867__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42868){var _e__41251__auto__ = e42868;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e42870){var _e__41251__auto__ = e42870;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42872 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42873 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42873);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42874__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42872);
}});
...
var temp__5751__auto___42929 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42929)){
var managed_print_level_42930 = temp__5751__auto___42929;
var _STAR_print_level_STAR__orig_val__42879_42931 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42880_42932 = managed_print_level_42930;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42880_42932);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42875_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42875_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42879_42931);
}} else {
job_fn();
}
