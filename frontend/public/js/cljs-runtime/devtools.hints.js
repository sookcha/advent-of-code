...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42436__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42436__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42436__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5751__auto___42507 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___42507)){
var seen_errors_42509 = temp__5751__auto___42507;
if(cljs.core.truth_(seen_errors_42509.has(self))){
} else {
seen_errors_42509.add(self);

var temp__5753__auto___42510 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___42510)){
var sense_42511 = temp__5753__auto___42510;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42511)].join(''));
} else {
}
}
} else {
