...
var o42287 = temp__5751__auto__;
var temp__5751__auto____$1 = (o42287["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o42288 = temp__5751__auto____$1;
return (o42288["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41244__auto__ = f;
return (o__41244__auto__["toString"]).call(o__41244__auto__);
} else {
return "";
}
}catch (e42294){var _ = e42294;
return "";
}});
...
try{var o__41244__auto___42738 = t;
(o__41244__auto___42738["cljs$lang$ctorPrWriter"]).call(o__41244__auto___42738,t,writer);
}catch (e42313){var __42739 = e42313;
}
...
var char_code = (function (){var o__41244__auto__ = (new String(char$));
return (o__41244__auto__["charCodeAt"]).call(o__41244__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41244__auto__ = String;
return (o__41244__auto__["fromCharCode"]).call(o__41244__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42338 = num_code;
switch (G__42338) {
case (1):
return (185);
...
var o__41244__auto__ = String;
return (o__41244__auto__["fromCharCode"]).call(o__41244__auto__,superscript_code);
});
/**
...
}catch (e42397){var _e__41251__auto__ = e42397;
return false;
}})())){
...
var vec__42398 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42398,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42427){
var vec__42428 = p__42427;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42428,(0),null);
...
var G__42751 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42752 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42751;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42419){
var G__42420 = cljs.core.first(seq42419);
var seq42419__$1 = cljs.core.next(seq42419);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42420,seq42419__$1);
}));
...
var vec__42440 = cljs.core.split_with((function (p1__42439_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42439_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42440,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42440,(1),null);
...
var vec__42446 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42446,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42446,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42756 = cljs.core.rest(remaining_tokens);
var G__42757 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42756;
name_tokens = G__42757;
continue;
} else {
...
var vec__42459 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42459,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42459,(1),null);
var vec__42462 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42462,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42462,(1),null);
var vec__42465 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42465,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42465,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42465,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42465,(3),null);
...
var vec__42482 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42482,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__42486 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42486,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42486,(1),null);
var vec__42489 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42489,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42489,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42508 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42508) : devtools.munging.parse_fn_info_deep.call(null,G__42508));
})()));
}
} else {
return fn_info;
...
var G__42773 = (arity + (1));
var G__42774 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42564,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42564,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42592_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42592_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42595_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42595_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___42776 = arguments.length;
var i__4819__auto___42777 = (0);
while(true){
if((i__4819__auto___42777 < len__4818__auto___42776)){
args__4824__auto__.push((arguments[i__4819__auto___42777]));

var G__42778 = (i__4819__auto___42777 + (1));
i__4819__auto___42777 = G__42778;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42611){
var G__42612 = cljs.core.first(seq42611);
var seq42611__$1 = cljs.core.next(seq42611);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42612,seq42611__$1);
}));
...
var G__42621 = arg;
var G__42621__$1 = (((G__42621 instanceof cljs.core.Keyword))?G__42621.fqn:null);
switch (G__42621__$1) {
...
var map__42645 = options;
var map__42645__$1 = cljs.core.__destructure_map(map__42645);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42645__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42645__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42645__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42645__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42646 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42646,(5),null);
...
var o__41244__auto__ = f;
return (o__41244__auto__["getBasis"]).call(o__41244__auto__);
});
/**
...
}catch (e42669){var _e__41251__auto__ = e42669;
...
var G__42793 = (obj[cljs.core.first(path)]);
var G__42794 = cljs.core.rest(path);
obj = G__42793;
path = G__42794;
continue;
} else {
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42710){
var vec__42711 = p__42710;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42711,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42711,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42711,(2),null);
...
var post_process = (function (p__42723){
var vec__42724 = p__42723;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42724,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42724,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42722_SHARP_){
return (obj[cljs.core.first(p1__42722_SHARP_)]);
}),sorted_matches);
