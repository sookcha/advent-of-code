...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq44973){
var G__44974 = cljs.core.first(seq44973);
var seq44973__$1 = cljs.core.next(seq44973);
var G__44975 = cljs.core.first(seq44973__$1);
var seq44973__$2 = cljs.core.next(seq44973__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44974,G__44975,seq44973__$2);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___45024 = arguments.length;
var i__4819__auto___45025 = (0);
while(true){
if((i__4819__auto___45025 < len__4818__auto___45024)){
args__4824__auto__.push((arguments[i__4819__auto___45025]));

var G__45026 = (i__4819__auto___45025 + (1));
i__4819__auto___45025 = G__45026;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq44978){
var G__44979 = cljs.core.first(seq44978);
var seq44978__$1 = cljs.core.next(seq44978);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44979,seq44978__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq44980){
var G__44981 = cljs.core.first(seq44980);
var seq44980__$1 = cljs.core.next(seq44980);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44981,seq44980__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___45030 = arguments.length;
var i__4819__auto___45031 = (0);
while(true){
if((i__4819__auto___45031 < len__4818__auto___45030)){
args__4824__auto__.push((arguments[i__4819__auto___45031]));

var G__45032 = (i__4819__auto___45031 + (1));
i__4819__auto___45031 = G__45032;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq44984){
var G__44985 = cljs.core.first(seq44984);
var seq44984__$1 = cljs.core.next(seq44984);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44985,seq44984__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___45034 = arguments.length;
var i__4819__auto___45035 = (0);
while(true){
if((i__4819__auto___45035 < len__4818__auto___45034)){
args__4824__auto__.push((arguments[i__4819__auto___45035]));

var G__45036 = (i__4819__auto___45035 + (1));
i__4819__auto___45035 = G__45036;
continue;
} else {
}
break;
...
var init = (function (){var G__44994 = kind;
var G__44994__$1 = (((G__44994 instanceof cljs.core.Keyword))?G__44994.fqn:null);
switch (G__44994__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44994__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq44991){
var G__44992 = cljs.core.first(seq44991);
var seq44991__$1 = cljs.core.next(seq44991);
var G__44993 = cljs.core.first(seq44991__$1);
var seq44991__$2 = cljs.core.next(seq44991__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44992,G__44993,seq44991__$2);
}));
...
var iter__4611__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45008(s__45009){
return (new cljs.core.LazySeq(null,(function (){
var s__45009__$1 = s__45009;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__45009__$1);
if(temp__5753__auto__){
var s__45009__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45009__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__45009__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__45011 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__45010 = (0);
while(true){
if((i__45010 < size__4610__auto__)){
var vec__45012 = cljs.core._nth(c__4609__auto__,i__45010);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45012,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45012,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__45011,id);

var G__45041 = (i__45010 + (1));
i__45010 = G__45041;
continue;
} else {
var G__45042 = (i__45010 + (1));
i__45010 = G__45042;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45011),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45008(cljs.core.chunk_rest(s__45009__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45011),null);
}
} else {
var vec__45015 = cljs.core.first(s__45009__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45015,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45015,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45008(cljs.core.rest(s__45009__$2)));
} else {
var G__45043 = cljs.core.rest(s__45009__$2);
s__45009__$1 = G__45043;
continue;
}
}
} else {
